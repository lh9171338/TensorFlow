...
if __name__ == '__main__':
    ...
    parser.add_argument('--logdir', type=str, default='tmp/fc/log', help='logdir for Tensorboard, give a string')
    parser.add_argument('--outputdir', type=str, default='output/fc', help='outputdir for image, give a string')
    parser.add_argument('--batch_size', type=int, default=64, help='batch size: give a int')
    parser.add_argument('--max_epoch', type=int, default=100000, help='Maximum epoch number: give a int')
